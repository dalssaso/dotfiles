...
vim.api.nvim_create_user_command('FindProjectFiles', project_files, {})
...
vim.keymap.set("n", "<leader><space>", ":FindProjectFiles<cr>", {noremap = true, silent = true, desc = 'Find files'})
